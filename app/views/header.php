        ...
        <?php if ($data['menu']): ?>
            <div class="d-flex justify-content-start">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a href="<?= ROOT ?>courses"
                           class="nav-link text-light <?= (isset($data['active']) && $data['active'] == 'courses') ? 'active' : '' ?>">Cursos</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= ROOT ?>books"
                           class="nav-link text-light <?= (isset($data['active']) && $data['active'] == 'books') ? 'active' : '' ?>">Libros</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= ROOT ?>shop/whoami"
                           class="nav-link text-light <?= (isset($data['active']) && $data['active'] == 'whoami') ? 'active' : '' ?>">Quienes
                            somos</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= ROOT ?>shop/contact"
                           class="nav-link text-light <?= (isset($data['active']) && $data['active'] == 'contact') ? 'active' : '' ?>">Contacto</a>
                    </li>
                </ul>
            </div>
